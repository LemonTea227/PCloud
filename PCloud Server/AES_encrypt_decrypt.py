...
SBOX = [['\x63', '\x7C', '\x77', '\x7B', '\xF2', '\x6B', '\x6F', '\xC5', '\x30', '\x01', '\x67', '\x2B', '\xFE', '\xD7', '\xAB', '\x76'],
        ...
        ['\x8C', '\xA1', '\x89', '\x0D', '\xBF', '\xE6', '\x42', '\x68', '\x41', '\x99', '\x2D', '\x0F', '\xB0', '\x54', '\xBB', '\x16']]  # substitution box

RSBOX = [['\x52', '\x09', '\x6A', '\xD5', '\x30', '\x36', '\xA5', '\x38', '\xBF', '\x40', '\xA3', '\x9E', '\x81', '\xF3', '\xD7', '\xFB'],
         ...
         ['\x17', '\x2B', '\x04', '\x7E', '\xBA', '\x77', '\xD6', '\x26', '\xE1', '\x69', '\x14', '\x63', '\x55', '\x21', '\x0C', '\x7D']]  # reverse substitution box
...
Matrix = [[02, 03, 01, 01],
          [01, 02, 03, 01],
          [01, 01, 02, 03],
          [03, 01, 01, 02]]  # this table is being used to mix_columns function
...
def create_round_key(chipper_key):
    ...
    for i in xrange(10):
        ...
        col3 = [use_sbox(pre_key[1][3]), use_sbox(pre_key[2][3]), use_sbox(pre_key[3][3]), use_sbox(pre_key[0][3])]
