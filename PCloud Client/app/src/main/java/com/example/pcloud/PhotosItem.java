...
class PhotosItem {
    ...
    public PhotosItem(String firstName, Bitmap firstAlbumIcon, String secondName, Bitmap secondAlbumIcon, String thirdName, Bitmap thirdPhotoIcon, String fourtName, Bitmap fourthPhotoIcon) {
    ...
    public PhotosItem(String firstName, Bitmap firstAlbumIcon, String secondName, Bitmap secondAlbumIcon, String thirdName, Bitmap thirdPhotoIcon) {
        this.firstName = firstName;
        this.firstPhotoIcon = firstAlbumIcon;
        this.secondName = secondName;
        this.secondPhotoIcon = secondAlbumIcon;
    ...
    public PhotosItem(String firstName, Bitmap firstAlbumIcon, String secondName, Bitmap secondAlbumIcon) {
        this.firstName = firstName;
        this.firstPhotoIcon = firstAlbumIcon;
        this.secondName = secondName;
        this.secondPhotoIcon = secondAlbumIcon;
